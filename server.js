...
class ConversationAnalyzer {
    ...
    async step1_intentConclusion(userInput) {
        ...
        // Programmatic Check for Clear matches (primary or synonyms)
        ...
        // Programmatic Check for Adequate Clarity (phrases)
        if (!intentFound) {
        ...
        // Qdrant Check for intent similarity (only if not found programmatically)
        if (!intentFound) {
    ...
    async step2_processConclusion(userInput) {
        ...
        // Programmatic Check for Clear matches
        ...
        // Programmatic Check for Adequate Clarity
        if (!processFound) {
    ...
    async analyzeFilter(filter, userInput) {
        ...
        // Programmatic Check for Operator
