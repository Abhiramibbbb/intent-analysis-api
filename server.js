...
const GOLD_TO_REF1_SCORES = {
  ...
  action: { 'create': 0.9, 'modify': 0.95, 'search': 0.85,'search for': 0.85, 'delete': 0.95,'delete record': 0.95 },
...
const GOLD_TO_REF2_SCORES = {
  ...
  action: { 'create': 0.6, 'modify': 0.9, 'search': 0.8, 'search for': 0.8,'delete': 0.85,'delete record': 0.85  },
